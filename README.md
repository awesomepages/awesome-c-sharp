...
* [abbaye/WpfHexEditorIDE](https://github.com/abbaye/WpfHexEditorIDE) - Wpf Hexeditor is a powerful and fully customisable user control for editing file or stream as hexadecimal, decimal and binary. Can be used in Wpf or WinForm application
...
* [fusionlanguage/fut](https://github.com/fusionlanguage/fut) - Ć programming language. Transpiling to C, C++, C#, D, Java, JavaScript, Python, Swift, TypeScript and OpenCL C.
